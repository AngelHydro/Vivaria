...
#### Angel SANCHEZ
S’occupe de la partie technique du projet (les classes et fonctionnalités qui apportent à la simulation).

#### Augstin MINOT
Notre directeur artistique de projet ; Il s'occupe de créer les textures de chaque saison, météo, animal, biome…

#### Benjamin MICHALAK
Benjamin s’occupe quant à lui du visuel du projet (comment le projet apparaît aux yeux de l’utilisateur) et s’assure que tout fonctionne convenablement durant la simulation.
...
## Notre projet
### Naissance de l’idée
Nous voulions tout d’abord créer une **application utile** qui apportera de la plus value à l’utilisateur mais n’ayant pas trouvé d’idée liant à la fois le côté utile tout en **respectant le thème des trophées NSI** de cette année.
